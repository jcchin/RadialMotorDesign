...
if __name__ == "__main__":
    ...
    ind.add_output('b_ry', 2.0, units='T', desc='Rotor yoke flux density')              # FEA
    ind.add_output('b_sy', 2.0, units='T', desc='Stator yoke flux density')             # FEA
    ind.add_output('b_t', 2.0, units='T', desc='Tooth Flux Density')                    # FEA
    ind.add_output('B_pk', 2.0, units='T', desc='Peak flux density for Hiperco-50')     # FEA
